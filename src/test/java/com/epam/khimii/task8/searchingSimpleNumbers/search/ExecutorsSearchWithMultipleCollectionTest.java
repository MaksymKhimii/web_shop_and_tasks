...
public class ExecutorsSearchWithMultipleCollectionTest {
    private ExecutorsSearchWithMultipleCollection executorsSearchWithMultipleCollection;
    ...
    public void shouldFindSimpleNumbersTest() {
        ...
        max = 40;
        threadCount = 3;
        executorsSearchWithMultipleCollection = new ExecutorsSearchWithMultipleCollection(min, max, threadCount, resultContainer);
        try {
            executorsSearchWithMultipleCollection.startSearching();
            Thread.sleep(1000);
        } catch (Exception e) {
            e.printStackTrace();
        }
